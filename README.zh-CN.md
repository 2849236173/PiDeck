...
[English](README.md) · [LinuxDO 友链](https://linux.do)
...
| **会话修改摘要** | Agent 完成后在聊天流末尾以紧凑列表展示本轮修改文件名和修改行数，超过 3 个可展开。 |
...
Markdown 渲染 + 流式输出、工具调用详情、会话结束修改文件摘要、模型/思考等级/上下文/缓存状态栏、Git 分支选择器、操作按钮（New Session · Stop · Restart · Files · History · Terminal）。
